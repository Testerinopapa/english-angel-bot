-- Superadmin privileges for designated emails: lorendamasio@gmail.com, gmalavaes@gmail.com, coelhobranco@proton.me

-- 1. Insert existing users with these emails into user_roles
INSERT INTO public.user_roles (user_id, role)
SELECT id, 'admin'::public.app_role
FROM auth.users
WHERE LOWER(email) IN ('lorendamasio@gmail.com', 'gmalavaes@gmail.com', 'coelhobranco@proton.me')
